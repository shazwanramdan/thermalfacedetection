...
string cascadeName = "/home/pi/Downloads/opencv-3.0.0/data/haarcascades/haarcascade_frontalface_alt.xml";
string nestedCascadeName = "/home/pi/Downloads/opencv-3.0.0/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
...
int main( int argc, char **argv )
{
    ...
    myWidget->setGeometry(400, 300, 1460, 480);
    ...
    QImage myImage1;
    myImage1 = QImage(320, 240, QImage::Format_RGB888);
    ...
    /*MyLabel myLab(myWidget);
    myLab.setGeometry(850, 10, 640, 480);
    myLab.setPixmap(QPixmap::fromImage(myImage1));*/
    ...
    /*facedetect *thread1 = new facedetect();
    QObject::connect(thread1, SIGNAL(updateImage(QImage)), &myLab, SLOT(setImage(QImage)));
    thread1->start();*/
...
/*
    ...
    {
        cout << "Processing " << i << " " <<  argv[i] <<n c++ executed endl;
